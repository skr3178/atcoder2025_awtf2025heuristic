...
void imovepath_markwall(string s, int id) {
    for (char c : s) {
        if (c == 'U') {
            wallh_mark[pos[id].Y][pos[id].X]=1;
            if (!wallh[pos[id].Y][pos[id].X] && !cell[pos[id].Y - 1][pos[id].X]) {
                cell[pos[id].Y][pos[id].X] = 0;
                pos[id].Y--;
                cell[pos[id].Y][pos[id].X] = 1;
            }
        } else if (c == 'D') {
            wallh_mark[pos[id].Y+1][pos[id].X]=1;
            if (!wallh[pos[id].Y + 1][pos[id].X] && !cell[pos[id].Y + 1][pos[id].X]) {
                cell[pos[id].Y][pos[id].X] = 0;
                pos[id].Y++;
                cell[pos[id].Y][pos[id].X] = 1;
            }
        } else if (c == 'L') {
            wallv_mark[pos[id].Y][pos[id].X]=1;
            if (!wallv[pos[id].Y][pos[id].X] && !cell[pos[id].Y][pos[id].X - 1]) {
                cell[pos[id].Y][pos[id].X] = 0;
                pos[id].X--;
                cell[pos[id].Y][pos[id].X] = 1;
            }
        } else if (c == 'R') {
            wallv_mark[pos[id].Y][pos[id].X+1]=1;
            if (!wallv[pos[id].Y][pos[id].X + 1] && !cell[pos[id].Y][pos[id].X + 1]) {
                cell[pos[id].Y][pos[id].X] = 0;
                pos[id].X++;
                cell[pos[id].Y][pos[id].X] = 1;
            }
...
void run_sa(VPII tactic, double time_limit) {
